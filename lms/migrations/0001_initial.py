    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authored_courses', to=settings.AUTH_USER_MODEL, verbose_name='Автор курса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_create', models.DateTimeField(auto_now_add=True, verbose_name='Время создания')),
                ('time_update', models.DateTimeField(auto_now=True, verbose_name='Время обновления')),
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.module', verbose_name='Курс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(0, 'не сдано'), (1, 'сдано'), (2, 'оценено')], default='не сдано', max_length=255, verbose_name='Статус')),
